...
<div class="col-lg-7" style="padding-bottom:120px">
				...
				<input type="hidden" name="_token" value="{!! csrf_token() !!}">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txtUser" placeholder="" value="{!! old('txtUser',isset($data)?$data['name']:null) !!}"/>
                            </div>
					...
					@endif
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control" name="txtEmail" placeholder="" value="{!! old('txtEmail',isset($data)?$data['email']:null) !!}" />
                            </div>
