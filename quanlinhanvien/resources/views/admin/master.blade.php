            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{!! URL::route('admin.user.getedit',Auth::user()->id)  !!}"><i class="fa fa-user fa-fw"></i> {!! Auth::user()->name !!}</a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
					...
					<ul class="nav dropdown-menu">
                                <li>
                                    <a href="{!! URL::route('admin.user.list') !!}">List Admin</a>
                                </li>
						 @if(Auth::user()->level==1)
                                <li>
                                    <a href="{!! URL::route('admin.user.getadd') !!}">Add Admin</a>
                                </li>
						 @endif
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav dropdown-menu">
                                <li>
                                    <a href="{!! URL::route('admin.department.list') !!}">List Department</a>
                                </li>
						
                                <li>
                                    <a href="{!! URL::route('admin.department.getadd') !!}">Add Department</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav dropdown-menu">
                                <li>
                                    <a href="{!! URL::route('admin.employee.list') !!}">List Employee</a>
                                </li>
                                <li>
                                    <a href="{!! URL::route('admin.employee.getadd') !!}">Add Employee</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
